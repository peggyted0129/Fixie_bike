...
$(document).ready(function () {
  ...
  $(window).scroll(function (e) {
    ...
    var jsImgNext = $('.js-img-next').offset().top;

    if (scrollPos + windowHeight / 2 >= jsImg) {
      $('.js-img').css('background-position', "-".concat(parseInt(scrollPos / 6), "px center"));
    }

    if (scrollPos + windowHeight / 2 >= jsImgNext) {
      $('.js-img-next').css('background-position', "-".concat(parseInt(scrollPos / 6), "px center"));
    }
  });
});
